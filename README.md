...
```text
                         ...
                         | # PtsVida: float                               |
                         +------------------------------------------------+
                         | + Heroi(nome: string, ptsVida: float)          |
                         | + LancarMagia(): void <<abstract>>             |
                         | + AtacarComArma(): void <<abstract>>           |
                         | + ReduzirVida(): void                          |
                         | + AumentarVida(): void                         |
                         | + GetNome(): string                            |
                         | + GetPtsVida(): float                          |
                   ...
                   |                                                           |
+---------------------------------------------+       +---------------------------------------------+
|              HeroiHorda                     |       |             HeroiAlianca                    |
+---------------------------------------------+       +---------------------------------------------+
|                                             |       |                                             |
+---------------------------------------------+       +---------------------------------------------+
| + HeroiHorda(nome: string, ptsVida: int)    |       | + HeroiAlianca(nome: string, ptsVida: int) |
| + LancarMagia(): void                       |       | + LancarMagia(): void                       |
| + AtacarComArma(): void                     |       | + AtacarComArma(): void                     |
| + ReduzirVida(): void                       |       | + AumentarVida(): void                      |
+---------------------------------------------+       +---------------------------------------------+
